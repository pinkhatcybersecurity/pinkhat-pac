...
class TFAwsElastiCacheCluster(TFSecurityCheckCore):
    """
    ...
    SECURITY_CHECKS = [
        lambda file_name, tf_resource_name, tf_resource_values: TFAwsElastiCacheCluster._sec_check_transit_encryption_enabled(
            file_name=file_name,
