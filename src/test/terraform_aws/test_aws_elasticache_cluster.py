...
test_results = [
    {
        ...
        "line_of_code": 1,
        "location": "Resource aws_elasticache_cluster name: transit_enabled doesn't enable encryption",
    ...
    },
    {
        ...
        "file_path": "aws_elasticache_cluster.tf",
        "line_of_code": 11,
        "location": "Resource aws_elasticache_cluster name: no_encryption_in_transit doesn't enable encryption",
        "module": "aws_elasticache_cluster",
        "severity": "High",
